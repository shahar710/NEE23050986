...
##Absolute range shift values
```{r}
#model
test_main_effect_abs=glmmTMB(
  data=data %>% 
    mutate(abs_shift=abs(shift_of_min_sm),
           shift_direction=case_when(shift_of_min_sm>0~"Poleward",
                                     shift_of_min_sm<0~"Equatorward")),
...
weights =sqrt_n)
#Model Summary
summary(test_main_effect_abs)
MuMIn::r.squaredGLMM(test_main_effect_abs)
#Model diagnostics
sjPlot::plot_model(test_main_effect_abs,type="diag")
sjPlot::plot_model(test_main_effect_abs,type="pred",show.data = T,terms = "abs_shift [all]",pred.type = "fe")
```
...
sjPlot::plot_model(test_sp_level,type="pred",show.data = T,terms="mean_shift_of_min_sm [all]",pred.type = "fe")
```
...
sjPlot::plot_model(test_percent_change,type="pred",pred.type = "re")
...
sjPlot::plot_model(test_main_effect_poleward,type="eff",show.data = T)
```
...
sjPlot::plot_model(test_main_effect_equatorward,type="eff",show.data = T,terms = "abs_shift [all]")
```
