...
sjPlot::plot_model(test_main_effect,type="eff")
#AIC
...
sjPlot::plot_model(test_main_effect_mean_shift,type="eff")
#AIC
...
sjPlot::plot_model(test_main_effect_leading,type="eff")
```
...
sjPlot::plot_model(test_main_effect_trailing,type="eff")
```
...
sjPlot::plot_model(test_sp_level,type="eff")
```
...
sjPlot::plot_model(test_main_effect_poleward,type="eff")
```
...
sjPlot::plot_model(test_main_effect_equatorward,type="eff")
```
...
sjPlot::plot_model(test_spat_pos,type="eff",terms=c("shift_of_min_sm","spatial_pos[-0.5,0,0.5]"))
#AIC
AIC(test_spat_pos)
```
...
sjPlot::plot_model(test_therm_pos,type="eff",terms=c("shift_of_min_sm","thermal_pos[-0.5,0,0.5]"))
...
sjPlot::plot_model(test_abs_lat,type="eff")
AIC(test_abs_lat)
```
...
sjPlot::plot_model(test_abs_lat_sp,type="eff",terms=c("abs_latitude_mean","spatial_pos[-0.5,0,0.5]"))
#AIC
AIC(test_abs_lat_sp)
```
...
#plot
sjPlot::plot_model(test_spat_mis,type="eff",terms=c('shift_of_min_sm',"spatial_pos[-0.5,0,0.5]","bt_bs_dist_of_min_sm[10,100,1000]"))
```
...
#plot
sjPlot::plot_model(test_tm,type="eff",terms=c('shift_of_min_sm',"spatial_pos[-0.5,0,0.5]","temporal_mismatch[-50,0,50]"))
```